...
package com.example.bottom.sheet.utils;
...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull ViewPagerBottomSheetBehavior<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link ViewPagerBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * ViewPagerBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link ViewPagerBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * ViewPagerBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link ViewPagerBottomSheetBehavior#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, ViewPagerBottomSheetBehavior)} instead.
         */
        @Deprecated
    ...
    public static <V extends View> ViewPagerBottomSheetBehavior<V> from(@NonNull V view) {
